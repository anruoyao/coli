...
return [
    'validation' => [
        ...
        'poll' => [
            'options_required' => '请为投票提供至少两个选项。',
            'invalid_data' => '投票数据无效。',
            'min_options' => '投票至少要有 :min 个选项。',
            'max_options' => '投票不能超过 :max 个选项。',
            'option_text' => '每个投票选项都必须有文字。',
            'option_text_min' => '投票选项文字至少需要 :min 个字符。',
            'option_text_max' => '投票选项文字不能超过 :max 个字符。'
        ],
        'wrong_type_attachment' => '无法将 :file_type 文件附加到此类型的帖子。',
    ]
];

...
class FollowAcceptNotification extends Notification implements ShouldQueue, DeduplicatableNotification
{
    use Queueable,
        BaseNotification,
        HasUserActor;
    ...
    public $notificationType = Notifications::FOLLOW_ACCEPTED;

...
class CommentMentionNotification extends Notification implements ShouldQueue, DeduplicatableNotification
{
    use Queueable,
        BaseNotification,
        HasUserActor;
    ...
    public $notificationType = Notifications::COMMENT_MENTIONED;

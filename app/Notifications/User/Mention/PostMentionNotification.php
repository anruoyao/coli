...
class PostMentionNotification extends Notification implements ShouldQueue, DeduplicatableNotification
{
    use Queueable,
        PostNotification,
        BaseNotification,
    ...
    public $notificationType = Notifications::POST_MENTIONED;

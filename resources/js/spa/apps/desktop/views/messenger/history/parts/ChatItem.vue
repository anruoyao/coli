<template>
	<RouterLink v-on:click="markAsRead" v-bind:to="{ name: 'messenger_chat', params: {chat_id: chatData.chat_id } }" class="flex gap-3 items-center pl-4 h-18" v-bind:class="[isSelectedChat ? 'bg-brand-900/5' : '']">
		<div class="shrink-0">

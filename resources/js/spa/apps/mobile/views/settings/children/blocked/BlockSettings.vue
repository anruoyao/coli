<template>
    ...
    <div v-else-if="state.isEmpty" class="flex flex-col items-center justify-center py-16">
        ...
        <p class="text-par-n text-lab-sc text-center max-w-md px-4">
    ...
    <div v-else>
        ...
        <div class="divide-y divide-bord-pr dark:divide-bord-pr">
            <div v-for="userData in state.blockedUsers" v-bind:key="userData.id" class="flex items-center justify-between px-4 py-3">
